...
RUSH_INFERERENCE_USE_WEBSERVICE = os.getenv('RUSH_INFERERENCE_USE_WEBSERVICE', "False").lower() == "true"
RUSH_INFERERENCE_WEBSERVICE_URL = os.getenv('RUSH_INFERERENCE_WEBSERVICE_URL', "http://localhost:8000/predict")
